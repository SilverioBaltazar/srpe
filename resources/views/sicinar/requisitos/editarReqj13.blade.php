                            ...
                            <div class="row"> 
                                @if (!empty($regjuridico->osc_d13)||!is_null($regjuridico->osc_d13))   
                                    <div class="col-xs-6 form-group">
                                        ...
                                        <label ><a href="/images/{{$regjuridico->osc_d13}}" class="btn btn-danger" title="Documento de registro en el IFREM en formato PDF"><i class="fa fa-file-pdf-o"></i>PDF
                                        </a>&nbsp;&nbsp;&nbsp;{{$regjuridico->osc_d13}}
                                        </label>
                                        <input type="hidden" name="doc_id13" id="doc_id13" value="17">
                                    </div>   
                                    <div class="col-xs-6 form-group">
                                        <label >Actualizar archivo digital de documento de registro en el IFREM en formato PDF</label>
                                ...
                                @else     <!-- se captura archivo 1 -->
                                    <div class="col-xs-6 form-group">
                                        <label >Archivo digital de documento de registro en el IFREM en formato PDF</label>
                                        <input type="file" class="text-md-center" style="color:red" name="osc_d13" id="osc_d13" placeholder="Subir archivo de Documento de registro en el IFREM en formato PDF" >
                                        <input type="hidden" name="doc_id13" id="doc_id13" value="17">
                                    </div>                                                
                                @endif 
