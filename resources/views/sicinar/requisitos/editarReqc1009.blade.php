            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => ['actualizarReqc1009',$regcontable->osc_folio], 'method' => 'PUT', 'id' => 'actualizarReqc1009', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            <div class="row">       
                            ...
                            <div class="row">
                                @if (!empty($regcontable->osc_d1009)||!is_null($regcontable->osc_d1009))   
                                    <div class="col-xs-4 form-group">
                                        <label >Septiembre Cuotas 5 al millar en formato PDF</label><br>
                                        <label ><a href="/images/{{$regcontable->osc_d1009}}" class="btn btn-danger" title="Septiembre Cuotas 5 al millar en formato PDF"><i class="fa fa-file-pdf-o"></i>PDF
                                        </a>&nbsp;&nbsp;&nbsp;{{$regcontable->osc_d1009}}
                                        </label>
                                        <input type="hidden" name="doc_id1009" id="doc_id1009" value="15">
                                    </div>   
                                    <div class="col-xs-4 form-group">
                                        <label >Septiembre Cuotas 5 al millar en formato PDF</label>
                                        <input type="file" class="text-md-center" style="color:red" name="osc_d1009" id="osc_d1009" placeholder="Subir archivo de Septiembre Cuotas 5 al millar en formato PDF" >
                                    </div>      
                                @else     <!-- se captura archivo 1 -->
                                    <div class="col-xs-4 form-group">
                                        <label >Septiembre archivo de Cuotas 5 al millar en formato Excel</label>
                                        <input type="file" class="text-md-center" style="color:red" name="osc_d1009" id="osc_d1009" placeholder="Subir archivo de Septiembre Cuotas 5 al millar en formato PDF" >
                                        <input type="hidden" name="doc_id1009" id="doc_id1009" value="15">
                                    </div>                                                
                                @endif 
                            ...
                            <div class="row">        
                                <div class="col-xs-2 form-group">
                                    <label >Septiembre $ aportación </label>
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\reqcontablesRequest','#actualizarRec1009') !!}
@endsection
