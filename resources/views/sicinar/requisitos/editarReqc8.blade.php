                            ...
                            <div class="row">
                                @if (!empty($regcontable->osc_d8)||!is_null($regcontable->osc_d8))   
                                    <div class="col-xs-4 form-group">
                                        ...
                                        <label ><a href="/images/{{$regcontable->osc_d8}}" class="btn btn-danger" title="Constancia de autorización para recibir donativos en formato PDF"><i class="fa fa-file-pdf-o"></i>PDF
                                    ...
                                    <div class="col-xs-4 form-group">
                                        ...
                                        <input type="file" class="text-md-center" style="color:red" name="osc_d8" id="osc_d8" placeholder="Subir archivo de constancia de autorización para recibir donativos en formato PDF" >
                                    </div>      
