                            ...
                            <div class="row">
                                @if (!empty($regoperativo->osc_d2)||!is_null($regoperativo->osc_d2))   
                                    <div class="col-xs-4 form-group">
                                        ...
                                        <label ><a href="/images/{{$regoperativo->osc_d2}}" class="btn btn-danger" title="Programa de trabajo en formato PDF"><i class="fa fa-file-pdf-o"></i>PDF
                                        </a>&nbsp;&nbsp;&nbsp;{{$regoperativo->osc_d2}}
                                        </label>
                                        <input type="hidden" name="doc_id2" id="doc_id2" value="16">
                                    </div>   
                                    <div class="col-xs-4 form-group">
                                        <label >Actualizar archivo de Programa de trabajo en formato PDF </label>
...
@section('request')
    ...
    <script type="text/javascript" src="{{ asset('vendor/jsvalidation/js/jsvalidation.js')}}"></script>
        {!! JsValidator::formRequest('App\Http\Requests\reqoperativosRequest','#actualizarReqop2') !!}
@endsection
