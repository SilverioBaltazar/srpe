                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                @if (!empty($regcontable->osc_d10)||!is_null($regcontable->osc_d10))   
                                    <div class="col-xs-4 form-group">
                                        <label >Enero Cuotas 5 al millar en formato PDF</label><br>
                                        <label ><a href="/images/{{$regcontable->osc_d10}}" class="btn btn-danger" title="Cuotas 5 al millar en formato PDF"><i class="fa fa-file-pdf-o"></i>PDF
                                        </a>&nbsp;&nbsp;&nbsp;{{$regcontable->osc_d10}}
                                        </label>
                                        <input type="hidden" name="doc_id10" id="doc_id10" value="15">
                                    </div>   
                                    <div class="col-xs-4 form-group">
                                        <label >Enero Cuotas 5 al millar en formato PDF</label>
                                        <input type="file" class="text-md-center" style="color:red" name="osc_d10" id="osc_d10" placeholder="Subir archivo de Cuotas 5 al millar en formato PDF" >
                                    </div>      
                                @else     <!-- se captura archivo 1 -->
                                    <div class="col-xs-4 form-group">
                                        <label >Enero archivo de Cuotas 5 al millar en formato Excel</label>
                                        <input type="file" class="text-md-center" style="color:red" name="osc_d10" id="osc_d10" placeholder="Subir archivo de Cuotas 5 al millar en formato PDF" >
                                        <input type="hidden" name="doc_id10" id="doc_id10" value="15">
                                    </div>                                                
                                @endif 
