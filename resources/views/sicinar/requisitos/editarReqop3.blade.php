                            ...
                            <div class="row">
                                @if (!empty($regoperativo->osc_d3)||!is_null($regoperativo->osc_d3))   
                                    <div class="col-xs-4 form-group">
                                        ...
                                        <label ><a href="/images/{{$regoperativo->osc_d3}}" class="btn btn-danger" title="Informe anual en formato PDF"><i class="fa fa-file-pdf-o"></i>PDF
                                        </a>&nbsp;&nbsp;&nbsp;{{$regoperativo->osc_d3}}
                                        </label>
                                        <input type="hidden" name="doc_id3" id="doc_id3" value="16">
                                    </div>   
                                    <div class="col-xs-4 form-group">
                                        <label >Actualizar archivo de Informe anual en formato PDF </label>
