  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Estadísticas OSC'S    </a></li>
              ...
              <table id="tabla1" class="table table-striped table-bordered table-sm">
                ...
                <tbody>
                  @foreach($regosc as $osc)
                    <tr>
                      <td style="color:darkgreen;">{{$osc->entidadfederativa_id}}</td>
                      <td style="color:darkgreen;">{{$osc->estado}}   </td>
      ...
      function drawStuff() {
        ...
        var options = {
          ...
          chart: { title: 'Numeralia básica',
                   subtitle: 'Gráfica de OSCs por estado' },
