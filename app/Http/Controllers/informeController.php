...
class informeController extends Controller
{
    ...
    public function actionBuscarInforme(Request $request)
    {
        ...
        if($regprogtrab->count() <= 0){
            toastr()->error('No existen registros del Informe de labores.','Lo siento!',['positionClass' => 'toast-bottom-right']);
        }            
    ...
    public function actionVerInformes(){
        ...
        if($regprogtrab->count() <= 0){
            toastr()->error('No existe informe de labores.','Lo siento!',['positionClass' => 'toast-bottom-right']);
        }
    ...
    public function actionExportInformePdf($id,$id2){
        ...
        $regprogdtrab=regProgdtrabModel::join('PE_CAT_UNID_MEDIDA','PE_CAT_UNID_MEDIDA.UMEDIDA_ID','=',
                ...
                ->select('PE_PROGRAMA_DTRABAJO.PARTIDA', 
                         ...
                         'PE_PROGRAMA_DTRABAJO.MESC_01', 'PE_PROGRAMA_DTRABAJO.MESC_02', 'PE_PROGRAMA_DTRABAJO.MESC_03', 
                         'PE_PROGRAMA_DTRABAJO.MESC_04', 'PE_PROGRAMA_DTRABAJO.MESC_05', 'PE_PROGRAMA_DTRABAJO.MESC_06', 
                         'PE_PROGRAMA_DTRABAJO.MESC_07', 'PE_PROGRAMA_DTRABAJO.MESC_08', 'PE_PROGRAMA_DTRABAJO.MESC_09', 
                         'PE_PROGRAMA_DTRABAJO.MESC_10', 'PE_PROGRAMA_DTRABAJO.MESC_11', 'PE_PROGRAMA_DTRABAJO.MESC_12'
                            )
                ->selectRaw('(PE_PROGRAMA_DTRABAJO.MESP_01+PE_PROGRAMA_DTRABAJO.MESP_02+PE_PROGRAMA_DTRABAJO.MESP_03+
                              ...
                              PE_PROGRAMA_DTRABAJO.MESP_10+PE_PROGRAMA_DTRABAJO.MESP_11+PE_PROGRAMA_DTRABAJO.MESP_12)
                              META_PROGRAMADA')
                ->selectRaw('(PE_PROGRAMA_DTRABAJO.MESC_01+PE_PROGRAMA_DTRABAJO.MESC_02+PE_PROGRAMA_DTRABAJO.MESC_03+
                              PE_PROGRAMA_DTRABAJO.MESC_04+PE_PROGRAMA_DTRABAJO.MESC_05+PE_PROGRAMA_DTRABAJO.MESC_06+
                              PE_PROGRAMA_DTRABAJO.MESC_07+PE_PROGRAMA_DTRABAJO.MESC_08+PE_PROGRAMA_DTRABAJO.MESC_09+
                              PE_PROGRAMA_DTRABAJO.MESC_10+PE_PROGRAMA_DTRABAJO.MESC_11+PE_PROGRAMA_DTRABAJO.MESC_12)
                              META_REALIZADA')                
