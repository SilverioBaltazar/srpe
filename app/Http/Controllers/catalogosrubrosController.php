...
class catalogosrubrosController extends Controller
{
    ...
    public function actionAltaNuevoRubro(Request $request){
        ...
        if($nuevorubro->save() == true){
            toastr()->success('Rubro social dado de alta.','ok!',['positionClass' => 'toast-bottom-right']);
    ...
    public function actionActualizarRubro(catalogosrubrosRequest $request, $id){
        ...
        if($regrubro->count() <= 0)
            ...
            toastr()->success('Rubros social actualizado.','¡Ok!',['positionClass' => 'toast-bottom-right']);
            /************ Bitacora inicia *************************************/ 
            setlocale(LC_TIME, "spanish");        
            $xip          = session()->get('ip');
            $xperiodo_id  = (int)date('Y');
...
public function actionBorrarRubro($id){
        ...
        if($regrubro->count() <= 0)
            ...
            $regrubro->delete();
            toastr()->success('Rubro social eliminado.','¡Ok!',['positionClass' => 'toast-bottom-right']);
